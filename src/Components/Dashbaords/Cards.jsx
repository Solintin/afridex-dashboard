          ...
          <div className="my-5 grid lg:grid-cols-3 gap-6 cursor-pointer">
            <div>
              <div
                ...
                className="flex flex-col rounded-xl transform hover:scale-105 transition-all duration-300   max-w-300px ml-2 mr-1"
              >
            ...
            <div>
              <div   onClick={handleClickOpen} className="flex flex-col rounded-xl transform hover:scale-105 transition-all duration-300   max-w-300px ml-2 mr-1">
                <div className=" p-6  h-48 space-y-24  rounded-xl bg-purple-700  flex flex-col">
                  <div className="flex justify-between">
                    <div className=" font-thin text-white text-base">
                      Afridex
