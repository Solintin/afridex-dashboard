              ...
              {[...Array(10)].map((i, idx) => {
                return (
                  <tr
                    onClick={handleLink}
                    key={idx}
                    className="hover:bg-gray-100 border-b border-gray-200 py-3 cursor-pointer odd:bg-gray-100s"
                  >
                    ...
                    <td className="text-sm px-3 leading-5 text-center whitespace-nowrap text-black font-medium">
                      <div className="bg-blue-100 w-min px-3 rounded-xl py-1 flex justify-center items-center">
